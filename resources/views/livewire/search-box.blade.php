<div x-data="{
    ...
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            <input {{-- wire:model.live.debounce.300ms='search' --}} {{-- wire:model='search' --}} x-model="search"
        ...
        <x-button {{-- wire:click='update' --}} x-on:click="$dispatch('search',{ search: search })">Search </x-button>
    </div>
</div>
